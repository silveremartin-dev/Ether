...
public class ProceduralGenerator {
     ...
     */
    public record PlanetPoint(double elevation, double temperature, double rainfall, Biome biome) {
    }
    ...
    public PlanetPoint getPlanetPoint(double lat, double lng, PlanetPreset preset) {
        // Initialize noise (should handle caching if performance issue, but for now new
        // instance is fast enough)
        ...
        return new PlanetPoint(e, temp, r, biome);
    }

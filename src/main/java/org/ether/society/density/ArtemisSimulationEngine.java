 ...
 * 
 * <h2>Artemis Layer</h2>
 * This engine implements the "Artemis" simulation layer, focusing on 
 * statistical density of populations, animals, and resources rather than
 * individual agent tracking. This ensures scalability to millions of entities.
 */
public class ArtemisSimulationEngine {
    private static final Logger logger = LoggerFactory.getLogger(ArtemisSimulationEngine.class);
    ...
    public ArtemisSimulationEngine() {

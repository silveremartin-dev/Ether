...
public record EcologyPreset(
    ...
    public static final EcologyPreset MARS_LIKE = new EcologyPreset(
            PlanetPreset.MARS_LIKE.name(), PlanetPreset.MARS_LIKE.name(), PlanetPreset.MARS_LIKE, 0.0, 0.0, 0.0, 0.0, 140.0, 1800.0, 30.0, 500.0, 98765L, null, null, null, null, null, null);

    public static final EcologyPreset VENUS_LIKE = new EcologyPreset(
            PlanetPreset.VENUS_LIKE.name(), PlanetPreset.VENUS_LIKE.name(), PlanetPreset.VENUS_LIKE, 0.0, 0.0, 0.0, 0.0, 95.0, 1400.0, 120.0, 0.0, 55555L, null, null, null, null, null, null);

    public static final EcologyPreset MOON_LIKE = new EcologyPreset(
            PlanetPreset.MOON_LIKE.name(), PlanetPreset.MOON_LIKE.name(), PlanetPreset.MOON_LIKE, 0.0, 0.0, 0.0, 0.0, 45.0, 600.0, 18.0, 10.0, 88888L, null, null, null, null, null, null);

    public static final EcologyPreset MERCURY_LIKE = new EcologyPreset(
            PlanetPreset.MERCURY_LIKE.name(), PlanetPreset.MERCURY_LIKE.name(), PlanetPreset.MERCURY_LIKE, 0.0, 0.0, 0.0, 0.0, 280.0, 3500.0, 40.0, 2.0, 66666L, null, null, null, null, null, null);

    public static final EcologyPreset TITAN_LIKE = new EcologyPreset(
            PlanetPreset.TITAN_LIKE.name(), PlanetPreset.TITAN_LIKE.name(), PlanetPreset.TITAN_LIKE, 0.0, 200.0, 0.0, 0.0, 30.0, 400.0, 25.0, 8000.0, 77711L, null, null, null, null, null, null);

    public static final EcologyPreset SUPER_EARTH = new EcologyPreset(
            PlanetPreset.SUPER_EARTH.name(), PlanetPreset.SUPER_EARTH.name(), PlanetPreset.SUPER_EARTH, 950.0, 2800.0, 5.0, 15.0, 220.0, 3200.0, 140.0, 35000.0, 44444L, null, null, null, null, null, null);

    public static final EcologyPreset EYEBALL_WORLD = new EcologyPreset(
            PlanetPreset.EYEBALL_WORLD.name(), PlanetPreset.EYEBALL_WORLD.name(), PlanetPreset.EYEBALL_WORLD, 180.0, 600.0, 0.8, 4.0, 110.0, 1600.0, 90.0, 12000.0, 33333L, null, null, null, null, null, null);

    public static final EcologyPreset WATER_WORLD = new EcologyPreset(
            PlanetPreset.WATER_WORLD.name(), PlanetPreset.WATER_WORLD.name(), PlanetPreset.WATER_WORLD, 80.0, 300.0, 0.4, 30.0, 50.0, 900.0, 75.0, 60000.0, 54321L, null, null, null, null, null, null);

    public static final EcologyPreset ICE_WORLD = new EcologyPreset(
            PlanetPreset.ICE_WORLD.name(), PlanetPreset.ICE_WORLD.name(), PlanetPreset.ICE_WORLD, 30.0, 150.0, 0.2, 1.5, 130.0, 2100.0, 60.0, 4000.0, 11111L, null, null, null, null, null, null);
